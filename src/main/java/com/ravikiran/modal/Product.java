...
public class Product {
	...
	public int hashCode() {
		return Objects.hash(brand, category, color, description, discountPersent, discountedPrice, id, imageUrl,
				numRating, price, quantity, Rating, reviews, sizes, title);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(brand, other.brand) && Objects.equals(category, other.category)
				...
				&& numRating == other.numRating && price == other.price && quantity == other.quantity
				&& Objects.equals(Rating, other.Rating) && Objects.equals(reviews, other.reviews)
